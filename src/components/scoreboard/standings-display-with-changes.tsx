...
import { useStandingsWithChanges } from '@/hooks/use-standings-with-changes';
      ...
      <CardContent className="flex-grow overflow-hidden">
        <ScrollArea className="h-full">
          <Table>
            <TableHeader>
              <TableRow>
                <TableHead className="text-center" style={{ fontSize: `${headerSize}rem`, height: `${rowHeightRem}rem`, width: arrowColumnWidth }}></TableHead>
                    ...
                    return (
                        <TableRow key={teamStat.id}>
                            <TableCell colSpan={12} className="p-0" style={{ height: `${ellipsisRowHeight}rem` }}>
                                <div className="relative flex items-center justify-center h-full text-white/60 tracking-widest" style={{ fontSize: `${ellipsisFontSize}rem`, bottom: '0.2em' }}>
                                    ...
                                </div>
                            </TableCell>
                        </TableRow>
                ...
                return (
                    ...
                    >
                        ...
                        <TableCell className="text-center">
                          {teamStat.positionChange === 'up' && (
                            <ArrowUp className="inline-block w-[1.2em] h-[1.2em] text-green-500" style={{ filter: 'drop-shadow(0 0 4px rgba(34, 197, 94, 0.8))' }} />
                          )}
                          {teamStat.positionChange === 'down' && (
                            <ArrowDown className="inline-block w-[1.2em] h-[1.2em] text-red-500" style={{ filter: 'drop-shadow(0 0 4px rgba(239, 68, 68, 0.8))' }} />
                          )}
                        </TableCell>
