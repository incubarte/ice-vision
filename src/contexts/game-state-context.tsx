...
// --- Lógica de Estado Inicial (Movida de vuelta aquí) ---
...
export const GameStateProvider = ({ children }: { children: ReactNode }) => {
  ...
  const fetchInitialData = useCallback(async () => {
      ...
      try {
        ...
        // Fallback to a default state, but mark as incomplete.
  ...
  useEffect(() => {
    ...
    if (selectedTournamentId) {
        ...
        // Only fetch if teams data is missing, indicating it's a lightweight tournament object.
...
// --- Exporting functions that were moved here ---
export { createDefaultFormatAndTimingsProfile, createDefaultScoreboardLayoutProfile, getInitialState };
